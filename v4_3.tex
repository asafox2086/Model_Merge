...
\hline \hline
Prototype & Cls-head agg. & 25.63 \\
\rowcolor{gray!10}
& Global feat. mean & 26.50 \\
& Support-only & 10.89 \\
\rowcolor{gray!10}
& Shuffled proto. & 19.57 \\
\hdashline
Weight & Uniform client & 58.33 \\
\rowcolor{gray!10}
& Binary support & 55.18 \\
& Client-size weight & 59.39 \\
\hline \hline
\rowcolor[HTML]{FFF9C4}
\textbf{Full} & \textbf{LAMP-Merge} & \textbf{62.21} \\
\noalign{\hrule height 1.25pt}
\end{tabular}
\end{table}
...
\begin{figure}
    ...
    \caption{Internal ablations of the Diagnostic Prototype Reconstruction Module (DPRM) and Long-tail Prevalence Calibration (LPC).}
...
\hline \hline
Collapse ratio $\downarrow$ & 30.63 & 79.02 \\
\rowcolor{gray!10}
Effective classes $\uparrow$ & 7.20 & 2.05 \\
Pred-true TV $\downarrow$ & 12.42 & 69.44 \\
\noalign{\hrule height 1.25pt}
\end{tabular}
\end{table}
...
\hline \hline
Blood & 8 & 11,959 & 1,712 & 3,421 & 17,092 & \includegraphics[width=1.28cm,height=0.66cm,keepaspectratio]{figures/sample_blood.png} \\
Derma & 7 & 7,007 & 1,003 & 2,005 & 10,015 & \includegraphics[width=1.28cm,height=0.66cm,keepaspectratio]{figures/sample_derma.png} \\
Organ-C & 11 & 12,975 & 2,392 & 8,216 & 23,583 & \includegraphics[width=1.28cm,height=0.66cm,keepaspectratio]{figures/sample_organ_c.png} \\
Organ-S & 11 & 13,932 & 2,452 & 8,827 & 25,211 & \includegraphics[width=1.28cm,height=0.66cm,keepaspectratio]{figures/sample_organ_s.png} \\
Ultrasound & 8 & 3,869 & 549 & 1,113 & 5,531 & \includegraphics[width=1.28cm,height=0.66cm,keepaspectratio]{figures/sample_ultrasound.png} \\
\noalign{\hrule height 1.25pt}
\end{tabular}
\end{table*}
