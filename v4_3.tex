...
\caption{Per-class prediction deviations on Ultrasound, averaged over the four visual backbones, $K\in\{3,5,7\}$, and the three Dirichlet skew levels. Values are predicted minus true class proportions in percentage points; zero denotes exact distributional agreement.}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.96\textwidth]{figures/new/05_hyperparameter_sensitivity.pdf}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.98\textwidth]{figures/new/07_tsne_output_probability.png}
