...
\begin{figure*}[t]
\centering
\includegraphics[width=0.88\textwidth]{figures/03_baseline_2x2_ablation.pdf}
\caption{Strict $2\times2$ DPR/LPC ablation for TIES-Merging and DARE-Linear baselines. Each bar reports overall ACC averaged over all five datasets, four backbones, and three client counts (60 client-average cells); no per-dataset results are shown.}
