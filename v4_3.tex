...
LAMP-Merge enables single-shot medical model merging without raw-image sharing or federated rounds. DPR reconstructs class evidence and LPC calibrates its prevalence; together, they improve ACC and prediction-collapse diagnostics across the full setting.
