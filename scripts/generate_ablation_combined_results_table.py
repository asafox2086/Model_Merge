...
ABLATION_LABELS = {
    ...
    "no_domain_preprocess": "my_merge -M1 prior",
    "no_modality_features": "my_merge -M1 prior",
    "no_medical_preprocess": "my_merge -M1 prior",
    "no_medical_prior": "my_merge -M1 prior",
    "no_client_information": "my_merge -M2 client_info",
    "no_diagnostic_information": "my_merge -M2 client_info",
    "no_rarity": "my_merge -M2 rarity",
    "no_focal": "my_merge -M2 focal",
    "no_domain_focus": "my_merge -M2 domain_focus",
    "no_fusion_selection": "my_merge -M3 fusion_select",
    "no_medical_fusion_selection": "my_merge -M3 fusion_select",
    "no_balanced_selection": "my_merge -M3 balanced_select",
    "no_layerwise": "my_merge -M3 layerwise",
    "no_residual": "my_merge -M3 residual",
    "no_candidate_bank": "my_merge -M3 candidate_bank",
    "no_calibration": "my_merge -calibration",
}
