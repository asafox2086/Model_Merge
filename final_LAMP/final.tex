...
Classifier-head aggregation & 0.2579 & \compactdrop{0.3630} \\
\rowcolor{gray!10}
Global-feature mean & 0.2645 & \compactdrop{0.3564} \\
Support-only synthetic head & 0.1137 & \compactdrop{0.5073} \\
\rowcolor{gray!10}
Shuffled-label prototype & 0.2002 & \compactdrop{0.4207} \\
Uniform client weight & 0.5839 & \compactdrop{0.0370} \\
\rowcolor{gray!10}
Binary support only & 0.5517 & \compactdrop{0.0692} \\
Global client-size weight & 0.5944 & \compactdrop{0.0266} \\
\noalign{\hrule height 1.25pt}
\end{tabular}
\end{table}
...
\rowcolor[HTML]{FFF9C4}
\textbf{LAMP-Merge} & \textbf{0.6209} & -- \\
No prevalence calibration & 0.5879 & \compactdrop{0.0330} \\
\rowcolor{gray!10}
Uniform prevalence prior & 0.5879 & \compactdrop{0.0330} \\
\noalign{\hrule height 1.25pt}
\end{tabular}
\end{table}
...
\hline \hline
\rowcolor[HTML]{FFF9C4}
\textbf{Accuracy} $\uparrow$ & \textbf{0.6211} & 0.2228 & \compactgain{+0.3983} \\
BA / macro recall $\uparrow$ & 0.5370 & 0.1492 & \compactgain{+0.3878} \\
\rowcolor{gray!10}
Macro F1 $\uparrow$ & 0.5238 & 0.0757 & \compactgain{+0.4481} \\
Collapse ratio $\downarrow$ & 0.3122 & 0.7902 & \compactdrop{-0.4780} \\
\rowcolor{gray!10}
Effective classes $\uparrow$ & 7.1322 & 2.0489 & \compactgain{+5.0833} \\
Pred-true TV $\downarrow$ & 0.1262 & 0.7040 & \compactdrop{-0.5778} \\
\noalign{\hrule height 1.25pt}
\end{tabular}
\end{table}
