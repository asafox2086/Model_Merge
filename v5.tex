...
\begin{figure}[!t]
    ...
    \caption{Internal ablations of DPR and LPC. Each setting reports paired ACC and Macro-F1 bars; the plotted abbreviations are defined in the ablation text above.}
...
\caption{Strict $2\times2$ DPR/LPC ablations for TIES-Merging and DARE-Linear. Each setting reports paired ACC and Macro-F1 bars. \textbf{All experimental datasets are included.}}
