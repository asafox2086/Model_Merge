...
def plot_metric(rows, metric, ylabel, output_base):
    ...
    draw_panel(axes[0], rows, "TIES", metric, f"BloodMNIST: {ylabel} / TIES", f"Test {ylabel}")
    draw_panel(axes[1], rows, "LAMP-Merge", metric, f"BloodMNIST: {ylabel} / LAMP-Merge", f"Test {ylabel}")
...
def plot_combined(rows):
    ...
    draw_panel(axes[0, 0], rows, "TIES", "acc", "BloodMNIST: Acc / TIES", "Test Acc")
    draw_panel(axes[0, 1], rows, "LAMP-Merge", "acc", "BloodMNIST: Acc / LAMP-Merge", "Test Acc")
    draw_panel(axes[1, 0], rows, "TIES", "macro_f1", "BloodMNIST: F1 / TIES", "Test F1")
    draw_panel(axes[1, 1], rows, "LAMP-Merge", "macro_f1", "BloodMNIST: F1 / LAMP-Merge", "Test F1")
