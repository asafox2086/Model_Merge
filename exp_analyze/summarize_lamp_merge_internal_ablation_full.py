...
MODE_LABELS = {
    ...
    "m1_only": "M1 only",
    "avg_m2": "avg+M2",
    "reference_avg_head": "Reference averaged head",
    "reference_avg_head_lpc": "Reference averaged head + LPC",
    "reference_ties_head": "Reference TIES head",
    "reference_ties_head_lpc": "Reference TIES head + LPC",
    "reference_dare_head": "Reference DARE head",
    "reference_dare_head_lpc": "Reference DARE head + LPC",
...
MODE_GROUPS = {
    ...
    "avg_m2": "Module-level",
    "reference_avg_head": "Module-level",
    "reference_avg_head_lpc": "Module-level",
    "reference_ties_head": "Module-level",
    "reference_ties_head_lpc": "Module-level",
    "reference_dare_head": "Module-level",
    "reference_dare_head_lpc": "Module-level",
