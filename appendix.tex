...
\begin{table*}[!t]
\centering
\caption{Class-wise BloodMNIST split statistics and representative samples. This expands the Blood row in Table~\ref{tab:dataset-statistics}: the class-count field is replaced by the class name, and each row gives one real training example from that class.}
\label{tab:blood-class-statistics}
\small
...
\textbf{Dataset} & \textbf{Class} & \textbf{Train} & \textbf{Val} & \textbf{Test} & \textbf{Total} & \textbf{Sample} \\
\hline \hline
\multirow{8}{*}{Blood} & Basophil & 852 & 122 & 244 & 1,218 & \includegraphics[width=0.54cm,height=0.54cm,keepaspectratio]{figures/appendix_blood_class_0.png} \\
\rowcolor{gray!10}
 & Eosinophil & 2,181 & 312 & 624 & 3,117 & \includegraphics[width=0.54cm,height=0.54cm,keepaspectratio]{figures/appendix_blood_class_1.png} \\
 & Erythroblast & 1,085 & 155 & 311 & 1,551 & \includegraphics[width=0.54cm,height=0.54cm,keepaspectratio]{figures/appendix_blood_class_2.png} \\
\rowcolor{gray!10}
 & Immature granulocytes & 2,026 & 290 & 579 & 2,895 & \includegraphics[width=0.54cm,height=0.54cm,keepaspectratio]{figures/appendix_blood_class_3.png} \\
 & Lymphocyte & 849 & 122 & 243 & 1,214 & \includegraphics[width=0.54cm,height=0.54cm,keepaspectratio]{figures/appendix_blood_class_4.png} \\
\rowcolor{gray!10}
 & Monocyte & 993 & 143 & 284 & 1,420 & \includegraphics[width=0.54cm,height=0.54cm,keepaspectratio]{figures/appendix_blood_class_5.png} \\
 & Neutrophil & 2,330 & 333 & 666 & 3,329 & \includegraphics[width=0.54cm,height=0.54cm,keepaspectratio]{figures/appendix_blood_class_6.png} \\
\rowcolor{gray!10}
 & Platelet & 1,643 & 235 & 470 & 2,348 & \includegraphics[width=0.54cm,height=0.54cm,keepaspectratio]{figures/appendix_blood_class_7.png} \\
\noalign{\hrule height 1.25pt}
\end{tabular}
\end{table*}
...
\caption{Representative BloodMNIST training examples, one for every class in Table~\ref{tab:blood-class-statistics}. Images are drawn directly from the labeled benchmark file used to construct the experimental partitions; they are shown only to document class appearance, not as training data for merging.}
