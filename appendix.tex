...
Section~\ref{app:algorithm-figure} provides the algorithmic form of LAMP-Merge and the visual summary of the internal ablation results.
...
\section{Algorithm and Ablation Figure}
\label{app:algorithm-figure}
...
\begin{figure}[!t]
    ...
    \caption{\textbf{Every internal variant of DPR and LPC falls below the full model.} Visual companion to the main-paper internal ablation tables; plotted abbreviations are defined in the ablation text above. No single component can be removed without loss, confirming that the two modules are jointly necessary.}
    \label{app:fig:internal_module_ablations}
\end{figure}
