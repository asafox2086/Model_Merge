...
- [Two-panel medical/natural comparison](strict_domain_resnet_k3_avg_feature_tsne.png)
...
python scripts/plot_strict_domain_tsne.py \
  ...
  --output-dir medmerge_empirical_study/results/experiment14_strict_domain_control/tsne \
  --device cuda:0
```
