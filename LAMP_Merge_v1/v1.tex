...
\newcommand{\avgcell}[1]{\begingroup\def\avgcontent{#1}\def\avgheader{Avg}\setlength{\fboxsep}{0pt}\ifx\avgcontent\avgheader\colorbox{AvgBlue}{\makebox[3.55em][c]{\rule{0pt}{2.25ex}\raisebox{0.12ex}{\smash{\bfseries #1}}}}\else\colorbox{AvgBlue}{\makebox[3.55em][c]{\strut #1}}\fi\endgroup}
