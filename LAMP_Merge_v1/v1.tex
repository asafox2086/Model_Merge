...
\newcommand{\avgcell}[1]{\begingroup\def\avgcontent{#1}\def\avgheader{Avg}\setlength{\fboxsep}{0pt}\ifx\avgcontent\avgheader\colorbox{AvgBlue}{\makebox[3.55em][c]{\strut\bfseries #1}}\else\colorbox{AvgBlue}{\makebox[3.55em][c]{\strut #1}}\fi\endgroup}
...
\begin{tabular}{lrcc}
\hline
\tblhead{Metric} & \lampcell{LAMP-Merge} & \tblhead{Best reference} & \tblhead{\(\Delta\) vs. LAMP} \\
\hline
