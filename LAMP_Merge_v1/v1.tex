...
\newcommand{\avgcell}[1]{#1}
\newcommand{\metriclampcell}[1]{\begingroup\setlength{\fboxsep}{0pt}\colorbox{LAMPYellow}{\makebox[7.05em][c]{\rule[-1.12ex]{0pt}{4.45ex}\bfseries\boldmath #1}}\endgroup}
...
\hline
Accuracy $\uparrow$ & \metriclampcell{0.5885} & 0.3156 & \gainup{+0.2729} \\
BA / macro recall $\uparrow$ & \metriclampcell{0.5747} & 0.1810 & \gainup{+0.3937} \\
Macro F1 $\uparrow$ & \metriclampcell{0.5352} & 0.1123 & \gainup{+0.4229} \\
Collapse ratio $\downarrow$ & \metriclampcell{0.2294} & 0.7477 & \gaindown{-0.5184} \\
Effective classes $\uparrow$ & \metriclampcell{8.0390} & 2.1360 & \gainup{+5.9030} \\
Pred-true TV $\downarrow$ & \metriclampcell{0.1510} & 0.6168 & \gaindown{-0.4658} \\
\hline
\end{tabular}
\end{table}
