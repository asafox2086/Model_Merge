...
\newcommand{\lampcell}[1]{\begingroup\setlength{\fboxsep}{0.65pt}\colorbox{LAMPYellow}{\makebox[5.6em][c]{\rule[-0.45ex]{0pt}{2.90ex}\bfseries\boldmath #1}}\endgroup}
\newcommand{\avgheadcell}{\begingroup\setlength{\fboxsep}{0pt}\colorbox{AvgBlue}{\makebox[3.35em][c]{\rule[-1.50ex]{0pt}{4.00ex}}}\endgroup}
\newcommand{\avgcell}[1]{\begingroup\def\avgcontent{#1}\def\avgheader{Avg}\ifx\avgcontent\avgheader\setlength{\fboxsep}{0pt}\colorbox{AvgBlue}{\makebox[3.35em][c]{\rule[-1.15ex]{0pt}{4.20ex}\bfseries #1}}\else\setlength{\fboxsep}{1.2pt}\colorbox{AvgBlue}{\makebox[2.85em][c]{\strut #1}}\fi\endgroup}
...
\hline
\headband
& \multicolumn{3}{c}{\tblhead{Blood}} & \avgheadcell & \multicolumn{3}{c}{\tblhead{Derma}} & \avgheadcell & \multicolumn{3}{c}{\tblhead{Organ-C}} & \avgheadcell & \multicolumn{3}{c}{\tblhead{Organ-S}} & \avgheadcell & \multicolumn{3}{c}{\tblhead{Ultrasound}} & \avgheadcell \\
