...
\begin{figure*}[t]
\centering
\textbf{Extended Visual Analyses.}\par\medskip
\includegraphics[width=0.62\textwidth]{figures/full_scope_predicted_distribution_ultrasound_stacked.png}
...
\small\noindent\textbf{Prediction-distribution diagnosis.} The generic merge allocates most test images to one dominant class, whereas LAMP-Merge retains a multi-class allocation close to the empirical test prevalence. Its accuracy gain therefore does not arise from stronger prediction collapse.
\end{minipage}
\vspace{0.4em}
...
\label{fig:tsne}
\begin{minipage}{0.94\textwidth}
\small\noindent\textbf{Representation diagnostic.} LAMP-Merge forms separated output-probability groups. Weight averaging, TIES-Merging, and DARE-Linear show compressed or entangled groups, consistent with the prediction-collapse diagnostics.
\end{minipage}
\vspace{0.4em}
...
\begin{minipage}{0.94\textwidth}
\small\noindent\textbf{Geometric summary.} The full method simultaneously preserves class separation, cross-client consistency, and prototype--client alignment. Controlled substitutions may increase one quantity, but do not preserve this joint profile or the corresponding full-scope accuracy.
\end{minipage}
\end{figure*}
\end{document}
