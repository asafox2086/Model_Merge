...
To visualize the prediction-distribution changes measured by the new diagnostic metrics, the representative Ultrasound predicted-class distribution in Fig.~\ref{fig:visual-chaosheng_predict} is provided in the Appendix. It shows that the generic merge concentrates predictions on one class, whereas LAMP-Merge recovers a broader class allocation aligned with the test distribution.
