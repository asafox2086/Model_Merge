...
\newcommand{\tblhead}[1]{\colorbox{HeaderGray}{\strut #1}}
\newcommand{\lampcell}[1]{\colorbox{LAMPYellow}{\strut #1}}
\newcommand{\avgcell}[1]{\colorbox{AvgBlue}{\strut #1}}
...
\subsubsection{5) Hyperparameter Settings and Environment:}
...
\hline
\texttt{avg} & 0.3345 & 0.2467 & 0.2822 & \avgcell{0.2878} & 0.6291 & 0.4700 & 0.6244 & \avgcell{0.5745} & 0.2261 & 0.1772 & 0.1396 & \avgcell{0.1810} & \underline{0.2864} & 0.1794 & 0.2475 & \avgcell{0.2378} & 0.2435 & 0.1581 & 0.1542 & \avgcell{0.1853} \\
...
\texttt{from} & 0.2989 & 0.2306 & 0.2052 & \avgcell{0.2449} & \underline{0.6713} & 0.4369 & 0.6580 & \avgcell{0.5887} & 0.2350 & 0.1560 & 0.1520 & \avgcell{0.1810} & 0.2207 & 0.2087 & 0.2476 & \avgcell{0.2257} & 0.2309 & 0.1506 & 0.2063 & \avgcell{0.1959} \\
...
\lampcell{\textbf{LAMP-Merge}} & \lampcell{\textbf{0.8002}} & \lampcell{\textbf{0.7999}} & \lampcell{\textbf{0.8007}} & \lampcell{0.8003} & \lampcell{\textbf{0.6745}} & \lampcell{\textbf{0.6761}} & \lampcell{\textbf{0.6763}} & \lampcell{0.6756} & \lampcell{\textbf{0.6074}} & \lampcell{\textbf{0.6069}} & \lampcell{\textbf{0.6076}} & \lampcell{0.6073} & \lampcell{\textbf{0.5531}} & \lampcell{\textbf{0.5524}} & \lampcell{\textbf{0.5517}} & \lampcell{0.5524} & \lampcell{\textbf{0.4762}} & \lampcell{\textbf{0.4762}} & \lampcell{\textbf{0.4762}} & \lampcell{0.4762} \\
\hline
\end{tabular}
}
\end{table*}
...
\tblhead{Method} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} \\
\hline
\texttt{avg} & 0.1565 & 0.1122 & 0.1384 & \avgcell{0.1357} & 0.2966 & \underline{0.4830} & \textbf{0.6688} & \avgcell{0.4828} & 0.1037 & 0.1218 & 0.0944 & \avgcell{0.1066} & 0.1308 & 0.1035 & 0.1416 & \avgcell{0.1253} & 0.1506 & 0.1506 & 0.1252 & \avgcell{0.1421} \\
...
\texttt{from} & 0.1565 & 0.1083 & 0.1671 & \avgcell{0.1440} & 0.2966 & 0.3406 & 0.4569 & \avgcell{0.3647} & 0.1232 & 0.1224 & 0.0650 & \avgcell{0.1035} & 0.1324 & 0.1105 & 0.0897 & \avgcell{0.1109} & 0.1575 & \underline{0.1578} & 0.1087 & \avgcell{0.1413} \\
...
\lampcell{\textbf{LAMP-Merge}} & \lampcell{\textbf{0.8482}} & \lampcell{\textbf{0.8483}} & \lampcell{\textbf{0.8493}} & \lampcell{0.8486} & \lampcell{\textbf{0.5992}} & \lampcell{\textbf{0.5920}} & \lampcell{\underline{0.5852}} & \lampcell{0.5921} & \lampcell{\textbf{0.6482}} & \lampcell{\textbf{0.6480}} & \lampcell{\textbf{0.6495}} & \lampcell{0.6486} & \lampcell{\textbf{0.5977}} & \lampcell{\textbf{0.5985}} & \lampcell{\textbf{0.5990}} & \lampcell{0.5984} & \lampcell{\textbf{0.4259}} & \lampcell{\textbf{0.4259}} & \lampcell{\textbf{0.4259}} & \lampcell{0.4259} \\
\hline
\end{tabular}
}
\end{table*}
...
\tblhead{Method} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} \\
\hline
\texttt{avg} & 0.1343 & 0.1082 & 0.1160 & \avgcell{0.1195} & 0.4638 & 0.4369 & 0.3696 & \avgcell{0.4234} & 0.1657 & 0.1043 & 0.0952 & \avgcell{0.1217} & 0.0844 & 0.0852 & 0.1710 & \avgcell{0.1135} & 0.1450 & 0.1327 & \underline{0.1884} & \avgcell{0.1554} \\
...
\texttt{from} & 0.1802 & 0.0781 & 0.1405 & \avgcell{0.1329} & 0.4695 & \underline{0.5121} & \textbf{0.6688} & \avgcell{0.5501} & \underline{0.2148} & \underline{0.1301} & 0.0972 & \avgcell{0.1474} & 0.0772 & 0.0798 & 0.1485 & \avgcell{0.1018} & 0.1836 & 0.1743 & 0.1776 & \avgcell{0.1785} \\
...
\lampcell{\textbf{LAMP-Merge}} & \lampcell{\textbf{0.8523}} & \lampcell{\textbf{0.8522}} & \lampcell{\textbf{0.8516}} & \lampcell{0.8520} & \lampcell{\textbf{0.5970}} & \lampcell{\textbf{0.5938}} & \lampcell{0.5860} & \lampcell{0.5923} & \lampcell{\textbf{0.5805}} & \lampcell{\textbf{0.5790}} & \lampcell{\textbf{0.5790}} & \lampcell{0.5795} & \lampcell{\textbf{0.5406}} & \lampcell{\textbf{0.5372}} & \lampcell{\textbf{0.5388}} & \lampcell{0.5389} & \lampcell{\textbf{0.4645}} & \lampcell{\textbf{0.4645}} & \lampcell{\textbf{0.4645}} & \lampcell{0.4645} \\
\hline
\end{tabular}
}
\end{table*}
...
\tblhead{Method} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} \\
\hline
\texttt{avg} & 0.1565 & 0.1186 & 0.1524 & \avgcell{0.1425} & 0.4569 & \underline{0.4830} & \textbf{0.6688} & \avgcell{0.5362} & 0.1068 & 0.1294 & 0.0787 & \avgcell{0.1050} & 0.0682 & 0.0604 & 0.1381 & \avgcell{0.0889} & 0.1527 & 0.1294 & 0.1465 & \avgcell{0.1429} \\
...
\texttt{from} & 0.1565 & 0.1495 & 0.1671 & \avgcell{0.1577} & 0.4569 & 0.2971 & \textbf{0.6688} & \avgcell{0.4743} & 0.1174 & 0.1220 & 0.1051 & \avgcell{0.1148} & 0.1133 & 0.1016 & 0.1380 & \avgcell{0.1176} & 0.1539 & 0.1252 & 0.1476 & \avgcell{0.1422} \\
...
\lampcell{\textbf{LAMP-Merge}} & \lampcell{\textbf{0.7737}} & \lampcell{\textbf{0.7753}} & \lampcell{\textbf{0.7748}} & \lampcell{0.7746} & \lampcell{\textbf{0.6374}} & \lampcell{\textbf{0.6251}} & \lampcell{\underline{0.6244}} & \lampcell{0.6290} & \lampcell{\textbf{0.6651}} & \lampcell{\textbf{0.6632}} & \lampcell{\textbf{0.6630}} & \lampcell{0.6638} & \lampcell{\textbf{0.6078}} & \lampcell{\textbf{0.6076}} & \lampcell{\textbf{0.6068}} & \lampcell{0.6074} & \lampcell{\textbf{0.4816}} & \lampcell{\textbf{0.4816}} & \lampcell{\textbf{0.4816}} & \lampcell{0.4816} \\
\hline
\end{tabular}
}
\end{table*}
...
\tblhead{Method} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} & \tblhead{$K=3$} & \tblhead{$K=5$} & \tblhead{$K=7$} & \avgcell{Avg} \\
\hline
\texttt{avg} & 0.1857 & 0.1199 & 0.1863 & \avgcell{0.1640} & 0.6688 & 0.6688 & 0.5682 & \avgcell{0.6353} & 0.2360 & 0.1348 & 0.1226 & \avgcell{0.1645} & 0.2978 & 0.0926 & 0.1447 & \avgcell{0.1784} & 0.1602 & 0.1282 & 0.1087 & \avgcell{0.1324} \\
...
\texttt{from} & 0.2727 & 0.1618 & 0.1942 & \avgcell{0.2096} & \underline{0.6715} & \underline{0.6780} & \underline{0.6399} & \avgcell{0.6631} & 0.2491 & 0.1832 & \textbf{0.1943} & \avgcell{0.2089} & 0.2435 & 0.2243 & \underline{0.1886} & \avgcell{0.2188} & \underline{0.1758} & 0.1360 & 0.1264 & \avgcell{0.1461} \\
...
\lampcell{\textbf{LAMP-Merge}} & \lampcell{\textbf{0.3908}} & \lampcell{\textbf{0.2679}} & \lampcell{\textbf{0.2483}} & \lampcell{0.3023} & \lampcell{0.5646} & \lampcell{\textbf{0.6846}} & \lampcell{\textbf{0.6688}} & \lampcell{0.6393} & \lampcell{\textbf{0.4460}} & \lampcell{\textbf{0.2242}} & \lampcell{0.1468} & \lampcell{0.2723} & \lampcell{0.2670} & \lampcell{\textbf{0.2296}} & \lampcell{\textbf{0.2558}} & \lampcell{0.2508} & \lampcell{\textbf{0.1947}} & \lampcell{\textbf{0.1608}} & \lampcell{0.1602} & \lampcell{0.1719} \\
\hline
\end{tabular}
}
\end{table*}
...
\begin{tabular}{lr}
\hline
\tblhead{Setting} & \tblhead{Mean Acc} \\
\hline
\lampcell{LAMP-Merge} & \lampcell{0.6209} \\
Classifier-head aggregation & 0.2579 \\
Global-feature mean & 0.2645 \\
Support-only synthetic head & 0.1137 \\
Shuffled-label prototype & 0.2002 \\
Uniform client weight & 0.5839 \\
Binary support only & 0.5517 \\
Global client-size weight & 0.5944 \\
\hline
\end{tabular}
\end{table}
...
\hline
\lampcell{LAMP-Merge} & \lampcell{0.6209} \\
No prevalence calibration & 0.5879 \\
Uniform prevalence prior & 0.5879 \\
...
\hline
Accuracy $\uparrow$ & \lampcell{0.5885} & 0.3156 & +0.2729 \\
BA / macro recall $\uparrow$ & \lampcell{0.5747} & 0.1810 & +0.3937 \\
Macro F1 $\uparrow$ & \lampcell{0.5352} & 0.1123 & +0.4229 \\
Collapse ratio $\downarrow$ & \lampcell{0.2294} & 0.7477 & -0.5184 \\
Effective classes $\uparrow$ & \lampcell{8.0390} & 2.1360 & +5.9030 \\
Pred-true TV $\downarrow$ & \lampcell{0.1510} & 0.6168 & -0.4658 \\
\hline
\end{tabular}
\end{table}
...
\caption{Joint t-SNE visualization of ResNet feature representations and diagnostic prototypes on the Blood dataset.}
\label{fig:tsne}
\end{figure*}
